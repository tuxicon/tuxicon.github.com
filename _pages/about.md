   ...
   <section class="page-section portfolio" id="portfolio">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div style="margin-bottom: 0px" class="rh col-md-6 col-lg-6 mb-5" id="project2"  ontouchstart="PlayVideo(2)" ontouchend="StopVideoPlay(2)" onmouseover="PlayVideo(2)" onmouseleave="StopVideoPlay(2)">
                ...
                <div class="row justify-content-between">	    
                    <div style="margin-bottom: 1rem" class="rh col-md-6 col-lg-6 mb-5" id="project3"  ontouchstart="PlayVideo(3)" ontouchend="StopVideoPlay(3)" onmouseover="PlayVideo(3)" onmouseleave="StopVideoPlay(3)">
                    ...
                    <div style="margin-bottom: 1rem" class="rh col-md-6 col-lg-6 mb-5 mb-lg-0" id="project4"  ontouchstart="PlayVideo(4)" ontouchend="StopVideoPlay(4)" onmouseover="PlayVideo(4)" onmouseleave="StopVideoPlay(4)" >
